...
#-------------------------------------------------------------------------
obstacle_crash = pygame.image.load("Obstacles\obstacle_crash.png").convert_alpha()
obstacle_crash_rect = obstacle_crash.get_rect(midbottom = (800, 324))
...
# game play code -------------------------------------------------------
    while running:   # code for main game
        ...
        if game_active:
            ...
            window.blit(obstacle_crash, obstacle_crash_rect)
            # ..............................................................
            ...
            obstacle_crash_rect.x -= 10 * environment_speed
            ...
            # collision -------------------------------------------------------------------
            if character_rect.colliderect(obstacle_crash_rect):
                crash_sound.play()
                game_active = False
            #------------------------------------------------------------------------------
